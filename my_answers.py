...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #print(X.shape)
        #print(X.T)
        #print(hidden_error * (1 - hidden_outputs) * hidden_outputs)
        X = np.reshape(X, (1, self.input_nodes))
        hidden_error_base = hidden_error * (1 - hidden_outputs) * hidden_outputs
        hidden_error_base = np.reshape(hidden_error_base, (1, self.hidden_nodes))
